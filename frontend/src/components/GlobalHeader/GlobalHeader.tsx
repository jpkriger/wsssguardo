  ...
  return (
    <div className="w-full h-22 px-40 border-b flex items-center justify-between">
      <div className="w-186 py-3 flex justify-start gap-5">
        <Link
          to="/projects"
          className="flex items-center gap-5 cursor-pointer group no-underline">
          <svg
            width="50"
            height="50"
            viewBox="0 0 50 50"
          ...
          <div className="flex flex-col items-center justify-center pt-1 gap-[-2px]! transition-all duration-300 group-hover:opacity-90 group-hover:brightness-110">
