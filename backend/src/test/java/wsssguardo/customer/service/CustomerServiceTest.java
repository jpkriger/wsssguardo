...
class CustomerServiceTest {
    ...
    void createShouldReturnMappedResponse() {
        ...
        CustomerResponseDTO expected = new CustomerResponseDTO(entity.getId(), "Test Customer", null);
    ...
    void updateFoundShouldReturnMappedResponse() {
        ...
        CustomerResponseDTO expected = new CustomerResponseDTO(id, "Updated Name", null);
